...
const TIERS = [
  {
    ...
    includes: [
      ...
      "Bilingual verdict + up to 3 next steps",
      "Email summary + verification link",
      "WhatsApp support (usually replies within 1 hr, 9am-9pm PKT)",
    ],
    idealFor: "You're about to sign a rent agreement and want to make sure nothing sneaky is in the fine print. Single-document analysis.",
    highlight: false,
  },
  {
    ...
    includes: [
      ...
      "Combined verdict weighing all documents together",
      "Bilingual verdict + up to 5 personalised next steps",
      "Full detailed email report + verification link",
      "WhatsApp support (usually replies within 1 hr, 9am-9pm PKT)",
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      "Full cross-document verification across all 5 files",
      "Category scores (Ownership, Identity, Encumbrance, Authority, Completeness)",
      "Timeline of key events + evidence appendix",
      "Severity breakdown of every finding",
      "Bilingual verdict + comprehensive next-step checklist (up to 10 steps)",
      "Full detailed email report + verification link",
      "Priority WhatsApp support (usually replies within 1 hr, 9am-9pm PKT)",
    ],
