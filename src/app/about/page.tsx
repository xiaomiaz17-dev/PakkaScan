        ...
        <div style={{ maxWidth: "720px", margin: "0 auto" }}>
          <div style={{ fontSize: "17px", color: "#334155", lineHeight: 1.8 }}>
            ...
            <p style={{ margin: "0 0 32px 0" }}>
              Upload your Bayana, Fard, Sale Deed, or CNIC. Typically within a few minutes, PakkaScan reads key clauses (in English and Urdu), cross-checks the details, and tells you honestly:
            </p>
